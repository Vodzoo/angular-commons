...
export class FormDirective<T extends { [K in keyof T]: AbstractControl }, UserTypes> implements OnInit {
  ...
  @Input() public saveDataWithService?: boolean = true; // root form only
  @Input() public saveInStorage?: boolean; // root form only
  ...
  @Input() public clearFormWithInitialData?: boolean = true; // initial data or form group data
